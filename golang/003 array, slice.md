# Массив и слайс
Массив - контейнер фиксированной длины, литерал: `[N]T`

Слайс - контейнер динамической длины, литерал: `[]T`
...
# Композитный литерал
Композитные литералы позволяют объявить и инициализировать массив и слайс добавлением `{}` к литералу контейнера.
...
>[!warning] TODO: Заменить прототипы функций на реальные
## len(), cap()
...
Встроенные функции `len()` и `cap()` возвращают длину и ёмкость. Ёмкость слайса больше или равна длине слайса.
